 ...
 */
public class VendeurNotificationFragment extends Fragment {
private View view ;
...
private List<com.example.moura.devmobile.Message>list_of_msgs=new ArrayList <>();
    ...
    public VendeurNotificationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_vendeur_notification, container, false);
         send_button=view.findViewById(R.id.to_send_btn);

        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_msg_vendeur);
      ...
      send_button.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              Send_recive_msg_vendeur srMsg=new Send_recive_msg_vendeur();
              FragmentTransaction ft=getFragmentManager().beginTransaction();


                  ft.replace(R.id.frameLayoutVendeur,srMsg);
                  ft.commit();
